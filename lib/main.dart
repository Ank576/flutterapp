...
import 'package:ank576/login_page/login_page_widget.dart';
...
class _MyAppState extends State<MyApp> {
  Stream<Ank576FirebaseUser> userStream;
  Ank576FirebaseUser initialUser;
  ...
  void initState() {
    super.initState();
    userStream = ank576FirebaseUserStream()
